...
public class ExtraMovesTest {
    ...
    public ExtraMovesTest() {
        this.remainingUses = randomNumberGenerator.nextInt(10) + 1;
        this.moves = randomNumberGenerator.nextInt(10) + 1;
        this.extraMoves = new ExtraMoves(remainingUses, moves);
    }
    ...
    public void checkMoves() {
        assertEquals(moves, extraMoves.getMoves(),
                "Moves is not correct.");
    }
